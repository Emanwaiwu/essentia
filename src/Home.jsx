      ...
      <ReactLenis root>
        <main className="scroll-smooth">
          ...
          >
            <div className="h-full flex flex-col justify-between">
              ...
              <div className="flex justify-center">
                {" "}
                <div className="font-medium text-white text-center max-h-[1440px]">
                  {" "}
                  <motion.div
          ...
          <section className=" p-7 max-w-[1440px] mx-auto" id="buildings">
            <div>
              <h1 className="font-medium text-[16.5rem] text-center text-[#E7E7E7] md:text-[8.5rem] lg:text-[11.5rem] xl:text-[13.5rem] sm:text-[15vw]">
                PROJECTS
              </h1>
          ...
          <section className=" overflow-visible" id="careers">
            <div className="p-7 max-w-[1440px] mx-auto sticky z-10">
              <div>
                <h1 className="font-medium text-[16.5rem] leading-[95%] text-[#E7E7E7] md:text-[8.5rem] lg:text-[11.5rem] xl:text-[13.5rem] sm:text-[20vw]">
                  Be Part of Our Crew
                </h1>
                <div className="heading">
                  [
          ...
          <section className="contact" id="contact">
            ...
            <div className=" text-[#B3B3B3] text-center sm:mt-20 font-medium cut-off-text max-h-[1440px]">
              <motion.div
                variants={buildVariant}
                initial="hidden"
                whileInView="show"
